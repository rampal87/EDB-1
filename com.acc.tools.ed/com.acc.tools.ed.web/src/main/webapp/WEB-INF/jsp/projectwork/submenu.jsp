<div class="subtab-container" id="subtab-container" style="clear: both;">
 	<div style="text-align:center; height:18px; width: 150px;border-right: 1px solid black;margin-left:10px;margin-top: 7px;background: white;border: 1px solid black;border-bottom: none;">
		<a href="./taskDetails.do" id="subtab1" class="subtabs">My Tasks</a>
	</div>
	<div style="text-align:center; height:18px; width: 150px;border-right: 1px solid black;margin-left:10px;margin-top: 7px;background: white;border: 1px solid black;border-bottom: none;">
		<a href="#" id="subtab2" class="subtabs">Team Tasks</a>
	</div>	
	<div style="text-align:center; height:18px; width: 150px;border-right: 1px solid black;margin-top: 7px;">
		<a href="#" id="subtab3" class="subtabs">Vacation Calendar</a>
	</div>	
</div>